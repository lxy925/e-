<template>
	<view class="page">
		...
		<view class="header" v-if="'userInfo'!=null">
			<img src="../../static/images/index/doctor.jpg" alt="" />
			<view class="user">
				<text class="username"> {{userInfo.name}}</text>
				<text class="user-info"> {{ userInfo.is_certified ? '已认证' : '未认证' }}</text>
			</view>
		</view>
		...
		<view class="order-box">
			...
			<view class="order-item">
				...
				<view class="box" style="margin-left: 0;" @click="goToPage('escortRegistration')">
