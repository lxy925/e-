<template>
  ...
  <custom-nav title="e陪无忧" :isHomePage="false"></custom-nav>
     ...
     <view class="service-information">
         <view class="service-info">
             ...
             <text class="s_2">¥</text>
             <text class="s_3">98 </text> 
             <text class="s_4">起/次 日常价 ¥178 起</text>
             <text class="s_5">已售114单</text>
         </view>
         <text class="s_6">长者陪诊 2h/3h/4h</text>
 ...
 <image src="../../static/images/order/img_1.png" alt=""/>
     ...
     <view class="fixed-buttons">
         ...
         <button class="order-now" style="border: none; position: relative;" @tap="goToOrder()">
...
.service-image{
 ...
 margin: 30rpx auto; /* 上下外边距为20rpx，左右自动 */
}
.customer-service{
    display: flex;
    justify-content: center;
