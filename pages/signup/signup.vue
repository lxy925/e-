         ...
         <!-- <button class="notice-btn" @click="showNotice" :disabled="!canShowNotice">查看报考须知</button> -->
		  <view class="pay">
		  	<view class="total-info">
		  		...
		  		<span class="total-amount" style="color:#DD5858;font-size: large;font-weight: bolder;">{{ selectedJobInfo.price }}</span>
				<span class="total-amount" style="color: black;">
				  【{{ selectedJobInfo && selectedJobInfo.description ? selectedJobInfo.description : '待选择' }}】
				</span>
		  	</view>
			 <button class="submit-btn" @click="handleSubmit">立即缴费</button>
		  </view>
