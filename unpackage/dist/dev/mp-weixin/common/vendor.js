...
exports.default = void 0;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _pageLifetimes = __webpack_require__(/*! ./lifecycle/pageLifetimes */ 233);
var _clone = __webpack_require__(/*! ./methods/clone */ 234);
var _dataset = __webpack_require__(/*! ./methods/dataset */ 235);
var _escape = __webpack_require__(/*! ./methods/escape */ 236);
var _event = __webpack_require__(/*! ./methods/event */ 237);
var _getTabBar = __webpack_require__(/*! ./methods/getTabBar */ 238);
var _relation = __webpack_require__(/*! ./methods/relation */ 239);
var _selectComponent = __webpack_require__(/*! ./methods/selectComponent */ 240);
var _setData = __webpack_require__(/*! ./methods/setData */ 241);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var _default = {
...
var _set2 = _interopRequireDefault(__webpack_require__(/*! ../utils/_set */ 242));
var _debounce = _interopRequireDefault(__webpack_require__(/*! ../utils/debounce */ 243));
/**
 * 老setData polyfill
...
var b = "development" === "development",
  ...
  A = T({"address":["127.0.0.1","192.168.1.23"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/HBuilderX.4.45.2025010502/HBuilderX.4.66.2025051912/HBuilderX/plugins/unicloud/**/*.js"]}),
...
var _default = {
  ...
  "subPackages": [{
    "root": "subPackageA",
    "pages": [{
      "path": "pages/escortRegistration/escortRegistration",
      "style": {
        "usingComponents": {}
      }
    }, {
    ...
    "root": "subPackageB",
    "pages": [{
      "path": "pages/wx_pay/wx_pay",
      "style": {
        "navigationBarTitleText": "支付页面"
      }
    }, {
      "path": "pages/patientManagement/patientManagement",
      "style": {
        "usingComponents": {}
      }
    }, {
    ...
    "pages": [{
      ...
      "path": "pages/showerror/showerror",
      "style": {
  ...
  "globalStyle": {
    ...
    "navigationBarBackgroundColor": "#1fc7d6",
    "navigationBarTitleText": "e陪无忧",
  ...
  "easycom": {
    "autoscan": true,
    "custom": {
      "^uni-pay$": "@/uni_modules/uni-pay/components/uni-pay/uni-pay.vue",
...
/***/ 374:
/*!************************************************!*\
  !*** D:/陪诊小程序/e-/static/images/health/tip.png ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 375:
/*!**************************************************!*\
  !*** D:/陪诊小程序/e-/static/images/health/water.png ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 376:
/*!************************************************!*\
  !*** D:/陪诊小程序/e-/static/images/health/cup.png ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 377:
/*!************************************************!*\
  !*** D:/陪诊小程序/e-/static/images/health/car.png ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 378:
/*!**************************************************!*\
  !*** D:/陪诊小程序/e-/static/images/health/adver.png ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"
...
/***/ 415:
/*!********************************************************!*\
  !*** D:/陪诊小程序/e-/uni_modules/uni-pay/js_sdk/js_sdk.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 42:
/*!********************************!*\
  !*** D:/陪诊小程序/e-/utils/jwt.js ***!
  \********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

// utils/jwt.js
var jwt = __webpack_require__(/*! jsonwebtoken */ 43);
var secret = 'fc9a8d7e4b4a2c1f0e3d2c7b6a5d4e3f2c110a9f8e7d6c1es4a3f2e1dee9b8a7';
module.exports = {
  ...
  verifyToken: function verifyToken(token) {
    try {
      ...
      throw new Error("token\u9A8C\u8BC1\u5931\u8D25: ".concat(e.message));
    }
  }
};
...
/***/ 43:
/*!******************************************************!*\
  !*** D:/陪诊小程序/e-/node_modules/jsonwebtoken/index.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
vkUtil.callFunction = function () {
  var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var debug = config.debug;
  var action = obj.action,
    data = obj.data,
    title = obj.title,
    _obj$needAlert = obj.needAlert,
    needAlert = _obj$needAlert === void 0 ? true : _obj$needAlert,
    _obj$errLog = obj.errLog,
    errLog = _obj$errLog === void 0 ? true : _obj$errLog;
  var name;
  var url;
  var callFunctionData = {};
  if ((0, _typeof2.default)(action) === "object") {
    name = action.name;
    url = action.action;
    if (url) {
      var _action$actionKey = action.actionKey,
        actionKey = _action$actionKey === void 0 ? "action" : _action$actionKey,
        _action$dataKey = action.dataKey,
        dataKey = _action$dataKey === void 0 ? "data" : _action$dataKey;
  ...
  if (debug) {
    ...
    Logger.params = (0, _typeof2.default)(data) == "object" ? JSON.parse(JSON.stringify(data)) : data;
  }
    ...
    uniCloud.callFunction({
      ...
      success: function success() {
        ...
        if (res.code === 0) {
          ...
          if (debug) Logger.result = (0, _typeof2.default)(res) == "object" ? JSON.parse(JSON.stringify(res)) : res;
      ...
      complete: function complete(res) {
        if (debug) {
          ...
          counterNum++;
          var logUrl = url ? "\u3010".concat(url, "\u3011") : "";
          var logFunCtionName = "\u3010\u4E91\u51FD\u6570\u8BF7\u6C42\u3011\u3010".concat(name, "\u3011").concat(logUrl);
          var logColorStr = "color:".concat(colorStr, ";font-size: 12px;font-weight: bold;");
...
vkUtil.getOpenid = function () {
  return new Promise(function (resolve, reject) {
    ...
    if (functionName) {
      vkUtil[functionName]().then(function (code) {
        vkUtil.callFunction({
          action: {
            name: "vk-pay",
            action: action,
...
vkUtil.timeFormat = function (time) {
  var fmt = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'yyyy-MM-dd hh:mm:ss';
  var targetTimezone = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 8;
  try {
    if (!time) {
